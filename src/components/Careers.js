...
const Careers = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Careers at Best Bone Specialist & Trauma Center in Punjab</title>
        <meta
          name="description"
          content="Looking for healthcare jobs in Punjab? Join our top-rated orthopaedic hospital and trauma center offering career opportunities for doctors, nurses, and support staff."
        />
      </Helmet>
...
>
  <div className="maincareers-overlay" data-aos="fade-up" data-aos-delay="0">
    <h1 className="maincareers-title">Join Our Orthopaedic & Trauma Care Team in Punjab</h1>
...
<div className="careers-main">
  ...
  <div className="careers-top-content">
    <p data-aos="fade-up" data-aos-delay="100">
      At <strong>Parhar Hospital, Phagwara, Punjab</strong>, we believe that exceptional
      healthcare begins with dedicated professionals.Recognized as one of the Best Orthopaedic Hospitals in Punjab, we are committed to delivering advanced bone, joint, and trauma care with excellence.
    </p>
    <p data-aos="fade-up" data-aos-delay="200">
      We are also known for having some of the Best Orthopaedic Surgeons in Punjab and experienced,specialists who provide world-class treatment for fractures, joint problems, and complex injuries. As a trusted
      Best Bone Specialist in Punjab and leading Trauma Center in Punjab, we continuously strive to improve patient care through skilled and compassionate professionals.We offer a supportive and growth-oriented work environment for doctors, nurses, paramedical staff, and administrative professionals. Whether you are experienced or starting your journey in healthcare, we welcome passionate individuals to grow with us and contribute to high-quality orthopaedic and trauma care.
    </p>
