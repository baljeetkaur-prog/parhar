...
const Home = () => {
  return (
    <>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>Best Orthopaedic Hospital in Phagwara,Punjab | Orthopedic Surgeon in Phagwara, Punjab</title>
        <meta
          name="description"
          content="Best Orthopedic doctor in Phagwara,Punjab at Parhar Hospital for Knee, hip, and shoulder replacement. Expert surgeon providing comprehensive care and advanced joint solutions."
        />
        <meta
          name="keywords"
