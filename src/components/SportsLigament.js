...
const SportsLigament = () => {
            ...
            <main className="sl-main">
              ...
              <div className="sl-flex-block" data-aos="fade-up" data-aos-delay="150">
                <div className="sl-flex-text">
                  <p>
                    Sports medicine is a specialized branch of <a href="https://parharhospitalphagwara.com/" title="orthopaedics">orthopaedics</a> focused on
  ...
  <a
    href="https://parharhospitalphagwara.com/services/x-ray"
    title="X-Ray"
  >
    X-Ray
  </a>
  , ultrasound, and biomechanical analysis to determine the exact nature of the injury.
</li>
