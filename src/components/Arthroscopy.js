        ...
        <div className="arthro-container">
          <div className="arthro-grid">
            ...
            <main className="arthro-main">
              ...
              <p>Arthroscopy is a cutting-edge minimally invasive surgical technique that allows <a href="https://parharhospitalphagwara.com/services/orthopaedic-surgery" title="orthopaedic surgeons"> orthopaedic surgeons</a> to diagnose, treat, and repair joint problems without making large incisions. At Parhar Hospital, Phagwara, we specialize in arthroscopy procedures for the <strong>knee, shoulder, hip, ankle, and other joints</strong>, ensuring patients experience minimal pain, faster recovery, and optimal joint function.</p>
<p>Our team of experienced surgeons uses high-precision cameras and micro-instruments to inspect and repair damaged tissues, making Parhar Hospital one of the <strong>best arthroscopy surgery hospitals in Phagwara</strong>.</p>
  ...
  <div className="arthro-flex-text">
    ...
    <p className="arthro-text">
      Knee arthroscopy is a minimally invasive procedure to diagnose and treat meniscus tears, ligament <a href="https://parharhospitalphagwara.com/services/arthroplasty-orthopaedic-surgery" title=" injuries">  injuries</a>, cartilage damage, and inflammation. At Parhar Hospital, our <a href="https://parharhospitalphagwara.com/" title="expert surgeons"> expert surgeons </a> use precise instruments to repair or remove damaged tissue, restore knee function, and speed up recovery.
    </p>
  </div>
