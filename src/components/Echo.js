...
<ul className="echo-tick-list">
  ...
  <h4>Conclusion</h4>
  <p>
    Parhar Hospital’s <strong>2D echo test center</strong> provides advanced echocardiography services with precise imaging and expert interpretation. As a trusted 2D echo clinic, <a href="https://parharhospitalphagwara.com/services/ct-scan" title="CT SCAN">CT SCAN</a>  and <a href="https://parharhospitalphagwara.com/" title="echo test laboratory">echo test laboratory</a> in Phagwara, we are dedicated to accurate diagnosis, personalized cardiac care, and timely intervention to ensure the best outcomes for every patient.
  </p>
</div>
              </div>
            </main>
